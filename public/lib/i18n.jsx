...
const dict = {
  pt: {
    ...
    "dash.nav.contas": "Contas",
    "dash.nav.drops": "Drops",
    "dash.nav.analytics": "Analytics",
    "dash.nav.metas": "Metas",
    "dash.nav.config": "Configurações",
    "dash.week.label": "Esta semana",
    "dash.week.contas": "contas",
    "dash.week.target": "drops alvo",
    "dash.kpi.cashout": "CASHOUT TOTAL",
    "dash.kpi.roi": "ROI GERAL",
    "dash.kpi.alert": "FALTA PEGAR\nDROP SEMANAL",
    "dash.kpi.contas": "CONTAS",
    "dash.kpi.bruto": "R$ 586,30 bruto",
    "dash.kpi.invested": "Investido: R$ 374,95",
    "dash.kpi.active": "8 ativas de 8",
    "dash.chart.eyebrow": "CASHOUT SEMANAL",
    "dash.chart.title": "Últimas 8 semanas",
    "dash.chart.btn": "Histórico",
    "dash.week2.title": "Semana Atual",
    "dash.week2.drops": "Drops",
    "dash.week2.best": "Melhor semana",
    "dash.week2.link": "Ver todos os drops",
    "dash.week2.bruto": "BRUTO",
    "dash.week2.cashout": "CASHOUT",
    "dash.table.title": "Performance por Conta",
    "dash.table.link": "Ver todas",
    "dash.table.conta": "CONTA",
    "dash.table.drops": "DROPS",
    "dash.table.bruto": "BRUTO",
    "dash.table.cashout": "CASHOUT",
    "dash.table.roi": "ROI",
  ...
  en: {
    ...
    "dash.nav.dashboard": "Dashboard",
    "dash.nav.contas": "Accounts",
    "dash.nav.drops": "Drops",
    "dash.nav.analytics": "Analytics",
    "dash.nav.metas": "Goals",
    "dash.nav.config": "Settings",
    "dash.week.label": "This week",
    "dash.week.contas": "accounts",
    "dash.week.target": "target drops",
    "dash.kpi.cashout": "TOTAL CASHOUT",
    "dash.kpi.roi": "OVERALL ROI",
    "dash.kpi.alert": "MISSING\nWEEKLY DROP",
    "dash.kpi.contas": "ACCOUNTS",
    "dash.kpi.bruto": "R$ 586.30 gross",
    "dash.kpi.invested": "Invested: R$ 374.95",
    "dash.kpi.active": "8 active of 8",
    "dash.chart.eyebrow": "WEEKLY CASHOUT",
    "dash.chart.title": "Last 8 weeks",
    "dash.chart.btn": "History",
    "dash.week2.title": "Current Week",
    "dash.week2.drops": "Drops",
    "dash.week2.best": "Best week",
    "dash.week2.link": "See all drops",
    "dash.week2.bruto": "GROSS",
    "dash.week2.cashout": "CASHOUT",
    "dash.table.title": "Account Performance",
    "dash.table.link": "See all",
    "dash.table.conta": "ACCOUNT",
    "dash.table.drops": "DROPS",
    "dash.table.bruto": "GROSS",
    "dash.table.cashout": "CASHOUT",
    "dash.table.roi": "ROI",
